...
def room_1() -> None:
    ...
    print(f"This game experience will have you search through mystery room 1 {emoji}, try to guess what the purpose of the room is!")
    ...
    if final_choice == "picnic":
        ...
        if final_choice == "food":
            ...
            global points
            points += 100
            print("Sorry, that's not exactly it. This room is for a picnic! But you still get 100 points for guessing.")
...
def room_2(points: int) -> int:
    ...
    print(f"This game experience will have you search through mystery room 2 {emoji}, try to guess what the purpose of the room is!")
    print("Let's get to it!")
    ...
    if final_choice == "garden":
        print("\U0001F3E1")
        points += 1000
        print("Wow, you got it! This is the garden of the house. For that amazingly accurate guess, you get 1000 points!")
    else:
        print("\U0001F140")
        points += 100
